...
function setEndLocation(element, closingToken, treeAdapter) {
    ...
    if (closingToken.location) {
        var tn = treeAdapter.getTagName(element),
            // NOTE:260 For cases like <p> <p> </p> - First 'p' closes without a closing tag and
...
//NOTE:990 patch open elements stack, so we can assign end location for the elements
...
exports.assign = function (parser) {
    //NOTE:920 obtain Parser proto this way to avoid module circular references
    var parserProto = Object.getPrototypeOf(parser),
        treeAdapter = parser.treeAdapter;


    //NOTE:970 patch _reset method
    ...
    parser._processToken = function (token) {
        ...
        //NOTE:220 <body> and <html> are never popped from the stack, so we need to updated
    ...
    parser._attachElementToTree = function (element) {
        //NOTE:580 _attachElementToTree is called from _appendElement, _insertElement and _insertTemplate methods.
    ...
    parser._findFosterParentingLocation = function () {
        //NOTE:1060 store last foster parenting location, so we will be able to find inserted text
    ...
    parser._insertCharacters = function (token) {
        ...
        //NOTE:890 if we have location assigned by another token, then just update end position

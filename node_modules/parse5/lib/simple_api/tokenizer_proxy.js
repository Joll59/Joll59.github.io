...
//Tokenizer proxy
//NOTE:1110 this proxy simulates adjustment of the Tokenizer which performed by standard parser during tree construction.
...
TokenizerProxy.prototype._handleEndTagToken = function (token) {
    ...
    if (!this.inForeignContent) {
        ...
        //NOTE:700 check for exit from integration point

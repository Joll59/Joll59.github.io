...
core.Node.prototype = {
  ...
  get ownerDocument() {
    // TODO:2000 when we move nodeType to Node.prototype and add an internal _nodeType, consult that instead.
  ...
  _attrModified: function(name, value, oldValue) {
    ...
    // TODO:1590 remove MutationEvents completely at some point
...
inheritFrom(core.Node, core.Document, {
  ...
  _createElementWithCorrectElementInterface: function (name, namespace) {
    ...
    // TODO:1170 eventually we should re-write the element-builder system to be namespace aware, but for now it is not.

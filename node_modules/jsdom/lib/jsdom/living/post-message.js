...
module.exports = function (message, targetOrigin) {
  ...
  // TODO:1790 targetOrigin === '/' - requires reference to source window
  // See https://github.com/tmpvar/jsdom/pull/1140#issuecomment-111587499
  if (targetOrigin !== "*" && targetOrigin !== this.origin) {
    return;
  }

  // TODO:1160 event.source - requires reference to source window
  // TODO:1140 event.origin - requires reference to source window
  // TODO:1150 event.ports
  // TODO:1130 event.data - structured clone message - requires cloning DOM nodes

...
(function() {
  ...
  var Stream = xpath.Stream = function Stream(str) {
    ...
    this.peeked = null;
    // TODO:1440 not really needed, but supposedly tokenizer also disambiguates
    // a * b vs. node test *
  ...
  function descendantDfs(nodeMultiSet, node, remaining, matcher, andSelf, attrIndices, attrNodes) {
    ...
    // TODO:1970 use optimization. Also try element.getElementsByTagName
  ...
  var axes = xpath.axes = {
    ...
    'attribute':
      function attribute(nodeList  /*destructive!*/, nodeTypeNum, nodeName, shouldLowerCase) {
        // TODO:1190 figure out whether positions should be undefined here.
        var matcher = new NodeMatcher(nodeTypeNum, nodeName, shouldLowerCase);
        var nodeMultiSet = new NodeMultiSet(false);
        if (null != nodeName) {
          // TODO:2020 with namespace
          for (var i = 0; i < nodeList.length; ++i) {
            var node = nodeList[i];
          ...
          for (var i = 0; i < nodeList.length; ++i) {
            ...
            if (null != node.attributes) {
              ...
              for (var j = 0; j < node.attributes.length; j++) {  // all nodes have .attributes
                ...
                if (matcher.matches(attr))  // TODO:210 I think this check is unnecessary
                  nodeMultiSet.addNode(attr);
              }
              nodeMultiSet.popSeries();
            }
  ...
  Evaluator.prototype = {
    val: function val(ast, ctx) {
      ...
      switch (ast[0]) {
        ...
        case '/':
          // TODO:1070 don't generate '/' nodes, just Axis nodes.
          var lhs = this.val(ast[1], ctx);

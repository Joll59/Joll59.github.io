...
function color(property1, property2, validator) {
  ...
  // NOTE:640 at this point rgb and hsl are replaced by hex values by clean-css
...
function unit(property1, property2, validator) {
  ...
  // NOTE:1080 there is no point in having different vendor-specific functions override each other or standard functions,
  //       or having standard functions override vendor-specific functions, but standard functions can override each other
  // NOTE:1190 vendor-specific property values are not taken into consideration here at the moment
  var value1 = property1.value[0][0];
  var value2 = property2.value[0][0];

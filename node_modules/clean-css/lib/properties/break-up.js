...
function background(property, compactable, validator) {
  ...
  if (property.value.length == 1 && property.value[0][0] == 'inherit') {
    // NOTE:210 'inherit' is not a valid value for background-attachment
    ...
    if (validator.isValidBackgroundAttachment(value[0])) {
      ...
      if (i > 0) {
        ...
        if (previousValue[0].indexOf('/') > 0) {
          ...
          // NOTE:1220 we do this slicing as value may contain metadata too, like for source maps
      ...
      // NOTE:1230 we do this slicing as value may contain metadata too, like for source maps
...
function widthStyleColor(property, compactable, validator) {
  ...
  // NOTE:1180 usually users don't follow the required order of parts in this shorthand,
